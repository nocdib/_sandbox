...
public class SketcherFrame extends JFrame {
  ...
  private void createElementTypeActions() {
    ...
    ellipseAction = new TypeAction("Ellipse", ELLIPSE,'E', CTRL_DOWN_MASK);

    // Initialize the array
    TypeAction[] actions = {lineAction, rectangleAction, circleAction, curveAction, ellipseAction};
    typeActions = actions;
    ...
    ellipseAction.putValue(LARGE_ICON_KEY, ELLIPSE24);
    ...
    ellipseAction.putValue(SMALL_ICON, ELLIPSE16);
    ...
    ellipseAction.putValue(SHORT_DESCRIPTION, "Draw ellipses");
  }
  ...
  private void createToolbar() {
    ...
    fillButton.addMouseListener(handler);                              // Sets the cursor on the button
    fillButton.setSelectedIcon(FILL24);                                // Set the icon for selected state
 }
  ...
  private JButton addToolbarButton(Action action) {
    ...
    button.addMouseListener(handler);                                  // Handler to set the cursor
  ...
  // Indicate whether or not element fill is on
  ...
  private JButton fillButton;                                          // The Fill button on the toolbar
...
// Element color actions
  ...
  private CursorHandler handler = new CursorHandler();                 // Sets the cursor on the toolbar buttons
