...
/*
 ...
 You could use a simple sorting method called the bubble sort. To sort an array into ascending order the process is as follows:
...
// You cannot conveniently use a StringTokenizer object or the indexOf() method
// in the String class because a word can end with a space or a punctuation character
// such as a period or a comma. For simplicity, I have assumed that a single quote
