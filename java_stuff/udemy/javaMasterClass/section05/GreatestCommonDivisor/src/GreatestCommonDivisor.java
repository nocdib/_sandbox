public class GreatestCommonDivisor {
    ...
    public static int getGreatestCommonDivisor(int first, int second) {
        if(first >= 10 && second >= 10) {
            // Get the lesser of the two numbers
            int lesser = first > second ? second : first;
            // Count down from the lower number and return the first number that has no remainder with both numbers
            for(int x = lesser; x > 0; x--) {
